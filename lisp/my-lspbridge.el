...
(setq lsp-bridge-auto-format-code-idle 0.2)

(global-set-key (kbd "M-n") 'acm-select-next)
(global-set-key (kbd "M-p") 'acm-select-prev)

(global-set-key (kbd "M-d") 'acm-doc-toggle)
(global-set-key (kbd "M-j") 'acm-doc-scroll-up)
(global-set-key (kbd "M-k") 'acm-doc-scroll-down)

(global-set-key (kbd "C-d") 'lsp-bridge-find-def)
